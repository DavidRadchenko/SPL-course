...
public class Reactor<T> implements Server<T> {
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        conId = connections.getCount();
        clientChan.configureBlocking(false);

        BidiMessagingProtocol<T> TftpProtocol = protocolFactory.get();
        MessageEncoderDecoder<T> endec = readerFactory.get();
        ...
        connections.newConnection(handler, conId);
        TftpProtocol.start(conId, connections);
