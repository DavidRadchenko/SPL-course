...
public class Product implements java.io.Serializable{
     ...
     */
    public long getStartId() { return this.startId; }
    ...
    public long getFinalId() {
        ...
        /**
         * @param sum - result of UseOn();
         *            The product final ID as a long.
         * final ID is the ID the product received as the sum of all UseOn();
         */
    public void setFinalId(long sum) {
            finalId = sum;
    }
     ...
     */
    public void addPart(Product p) { parts.add(p); }
